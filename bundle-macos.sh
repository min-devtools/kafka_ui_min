...
APP_PATH="$ROOT_DIR/src-tauri/target/release/bundle/macos/KafkaMin.app"
...
printf '  sudo xattr -rd com.apple.quarantine /Applications/KafkaMin.app\n'
printf '  open /Applications/KafkaMin.app\n'
