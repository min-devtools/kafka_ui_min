...
export function DateTimeModal({ value, onApply, onClose }: Props) {
  ...
  // Enter applies, Esc cancels — capture phase so this swallows the key before any
  // parent modal (e.g. ResetModal) or app-level shortcut sees it. Mirrors Dialog.tsx.
  useEffect(() => {
